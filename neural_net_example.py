"""
Copied from https://towardsdatascience.com/a-step-by-step-implementation-of-gradient-descent-and-backpropagation-d58bda486110
"""
...
class NeuralNetwork:
    ...
    def gradient_descent(self, x, y, iterations):
        for i in range(iterations):
            ...
            print(self.sigmoid_derivative(Xj, self.wjk))
            print('Xj.T:')
            print(Xj.T)
            ...
            g_wij = np.dot(
                Xi.T, 
                np.dot(
                    (y - yhat) * self.sigmoid_derivative(Xj, self.wjk),
                    self.wjk.T)
...
if __name__ == '__main__':
    ...
    print('Random starteing input to hidden weights: ')
